...
Код разбит на классы логично.

Не учтена одна особенность работы с методом fetch.


Что можно лучше.

1. Чтобы не перечислять все атрибуты карточки в параметрах конструктора класса Card, можно рассмотреть вариант передачи в параметр
конструктора класса Card объекта, например objCard, со свойствами - атрибутами карточки (подробный комментарий в классе Card).
2. Лучше в параметры класса CardList передавать не функцию, возвращающую экземпляр класса Card, а функцию, возвращающую элемент карточки
для каждого экземпляра (подробный комментарий в классе CardList).
3. Лучше методу open класса CardPopup ввести параметр url, а не evt (подробный комментарий в классе CardPopup).


Что надо исправить.

1. Структура методов Api должна быть несколько изменена в части обработки неуспешного ответа сервера (подробный комментарий в классе Api).

___________________________________________________________________________________________________________________________________________
REVIEW2. Резюме2.

Ошибка исправлена, рекомендации учтены.
